        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-jet-nav-link href="{{ route('bands') }}" :active="request()->routeIs('bands')">
                        {{ __('Bands') }}
                    </x-jet-nav-link>
                </div>
            </div>
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                ...
                <div class="ml-3 relative">
                    ...
                    @else
                        <a href="{{ route('login') }}" class="underline text-sm">Inloggen</a>
                        
                        @if (Route::has('register'))
                            <a href="{{ route('register') }}" class="ml-4 underline text-sm">Registreren</a>
                        @endif
                    @endauth
                </div>
            </div>
